...
public class AcknowledgmentsController {
  ...
  public void initialize() {
    ...
    setLinkAction(MaterialFX, "https://mvnrepository.com/artifact/io.github.palexdev/materialfx/11.13.8");
    setLinkAction(GestureFX, "https://github.com/tom91136/GestureFX");
    setLinkAction(ControlsFX, "https://mvnrepository.com/artifact/org.controlsfx/controlsfx/11.1.2");
    ...
    setLinkAction(SLF4SimpleBinding, "https://mvnrepository.com/artifact/org.slf4j/slf4j-simple/1.7.30");
    setLinkAction(OracleDatabaseJDBCUCP, "https://mvnrepository.com/artifact/com.oracle.database.jdbc/ucp");
    setLinkAction(OJDBC8, "https://mvnrepository.com/artifact/com.oracle.database.jdbc/ojdbc8/19.6.0.0");
    ...
    setLinkAction(JAXBRuntime, "https://mvnrepository.com/artifact/org.glassfish.jaxb/jaxb-runtime/4.0.2");
    setLinkAction(PostgreSQL, "https://mvnrepository.com/artifact/org.postgresql/postgresql/42.5.1");
    ...
    setLinkAction(JavaNativeAccess, "https://mvnrepository.com/artifact/net.java.dev.jna/jna/5.12.1");
    setLinkAction(HibernateORM, "https://mvnrepository.com/artifact/org.hibernate.orm/hibernate-c3p0/6.1.6.Final");
    setLinkAction(JFoeniX, "https://mvnrepository.com/artifact/com.jfoenix/jfoenix/9.0.10");
    setLinkAction(ApacheCommons, "https://mvnrepository.com/artifact/org.apache.commons/commons-math3/3.6.1");
    setLinkAction(TestFXCore, "https://mvnrepository.com/artifact/org.testfx/testfx-core/4.0.16-alpha");
    setLinkAction(JUnitJupiterAPI, "https://mvnrepository.com/artifact/org.junit.jupiter/junit-jupiter-api/5.8.1");
    setLinkAction(TestFXJUnit, "https://mvnrepository.com/artifact/org.testfx/testfx-junit5/4.0.16-alpha");
    setLinkAction(OJDBC10, "https://mvnrepository.com/artifact/com.oracle.ojdbc/ojdbc10/19.3.0.0");
    setLinkAction(JUnitJupiterEngine, "https://mvnrepository.com/artifact/org.junit.jupiter/junit-jupiter-engine/5.8.1");
    setLinkAction(JUnitJupiterAggregator, "https://mvnrepository.com/artifact/org.junit.jupiter/junit-jupiter/5.6.0");
